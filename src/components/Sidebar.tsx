      ...
      <nav className="flex-1 px-3 space-y-1 mt-4">
        {navItems.map((item) => (
          <Link
            key={item.name}
            href={item.href}
            className="flex items-center gap-3 px-3 py-2.5 text-muted hover:bg-slate-700/10 dark:hover:bg-slate-700/30 hover:text-primary rounded-lg transition-all duration-200 group"
          >
