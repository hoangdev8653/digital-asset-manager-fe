...
export default function AssetDetail() {
    ...
    const asset = assetData?.data?.data?.data;
    console.log(asset);
            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8 mb-6 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
                    ...
                    <div className="flex items-center gap-3">
                        <Link href="/report">
                            <Button variant="outline" className="cursor-pointer gap-2 text-amber-600 border-amber-200 hover:bg-amber-50 hover:text-amber-700">
